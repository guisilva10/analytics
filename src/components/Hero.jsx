  ...
  return (
    <div className='text-white'>
      <div className='max-w-[800px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center'>
        <p className='text-[#0000e6] font-bol#000080d p-2'>
        ...
        <button className='bg-[#0000e6] w-[200px] rounded-md font-medium my-6 mx-auto py-3 text-white hover:bg-[#000090]'>Começar</button>
      </div>
    </div>
  );
};
